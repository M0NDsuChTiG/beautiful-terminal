...
sudo apt update
sudo apt install -y zsh grc git curl whois jq mtr-tiny bind9-host grepcidr tealdeer lsd bat fzf btop fd-find zoxide kmon fastfetch duf micro procs lazygit
